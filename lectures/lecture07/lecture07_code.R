...
data.frame(x = c(-3,3)) %>%
    ...
    ggplot2::theme_bw(24) +
    ggplot2::geom_vline(xintercept = -0.605, color = "red", size = 1.5) +
    ggplot2::theme(axis.title = element_blank())
ggsave("rats1.png", height = 4, width = 5)
...
data.frame(x = c(-3,3)) %>%
    ...
    ggplot2::geom_vline(xintercept = -0.605, color = "red", size = 1.5) +
    ggplot2::theme(axis.title = element_blank())
ggsave("rats2.png", height = 4, width = 5)
...
data.frame(x = c(-3,3)) %>%
    ...
    ggplot2::theme(axis.title = element_blank(),
                   axis.text = element_blank(),
                   axis.ticks = element_blank())
ggsave("one_sided_95_conf.png", height = 4, width = 4)
